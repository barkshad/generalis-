    ...
    <header className="w-full sticky top-0 bg-white/80 backdrop-blur z-50">
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-4">
          <a href="#about" className="text-sm font-medium uppercase hover:text-primary transition-colors">About</a>
      ...
      {isMobileMenuOpen && (
        <div id="mobileNav" className="md:hidden border-t">
          <div className="px-6 py-4 flex flex-col gap-3">
            <a href="#about" className="uppercase" onClick={closeMobileMenu}>About Us</a>
